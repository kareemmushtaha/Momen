...
class SocialsDataTable extends DataTable
{
   ...
   public function dataTable(DataTables $dataTables, $query)
   {
      return datatables($query)
         ->addColumn('actions', 'admin.socials.buttons.actions')
         ...
         ->addColumn('checkbox', '<label class="mt-checkbox mt-checkbox-single mt-checkbox-outline">
			<input type="checkbox" class="selected_data" name="selected_data[]" value=""> <span></span></label>')
         ->rawColumns(['checkbox', 'show_action', 'actions', 'status', 'user', 'date']);
   }
   ...
   {
      return Social::query()->orderBy('id', 'desc');
   ...
   protected function getColumns()
   {
      return [
         ...
         [
            'name'  => 'url_name',
            'data'  => 'url_name',
            'title' => trans('admin.url_name'),
         ],
         [
            'name'  => 'fa_icon',
            'data'  => 'fa_icon',
            'title' => trans('admin.fa_icon'),
         ],
         [
            'name'  => 'url',
            'data'  => 'url',
