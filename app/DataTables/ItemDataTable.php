...
class ItemDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.item.buttons.actions')
            ->addColumn('item_photo', 'admin.item.buttons.item_photo')
            ->addColumn('status', 'admin.socials.buttons.status')

            ->addColumn('itemtype', 'admin.item.buttons.itemtype')
            ...
            ->rawColumns(['checkbox','data','item_photo', 'status','itemtype','actions']);
    }
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'Item_name',
                 'data'=>'Item_name',
                 'title'=>trans('admin.Item_name'),
		    ],

				[
                 'name'=>'Item_price',
                 'data'=>'Item_price',
                 'title'=>trans('admin.Item_price'),
		    ],
				[
                 'name'=>'Item_price_overnight',
                 'data'=>'Item_price_overnight',
                 'title'=>trans('admin.Item_price_overnight'),
		    ],
				...
				[
                 'name'=>'item_photo',
                 'data'=>'item_photo',
                 'title'=>trans('admin.item_photo'),
		    ],

				[
                 'name'=>'itemtype',
                 'data'=>'itemtype',
                 'title'=>trans('admin.item_types_id'),
		    ],
            [
                'name'  => 'status',
                'data'  => 'status',
