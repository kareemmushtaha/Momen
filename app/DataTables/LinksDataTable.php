...
class LinksDataTable extends DataTable
{
   ...
   public function dataTable(DataTables $dataTables, $query)
   {
      return datatables($query)
         ->addColumn('actions', 'admin.links.buttons.actions')
         ->addColumn('status', 'admin.links.buttons.status')
         ->addColumn('link_place', 'admin.links.buttons.link_place')
         ...
         ->rawColumns(['checkbox', 'show_action', 'actions', 'status', 'link_place','user', 'date']);
   }
   ...
   {
      return Link::query()->orderBy('id', 'desc');
