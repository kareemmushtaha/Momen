...
class imageItemDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.imageitem.buttons.actions')
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'imageItem_id',
                 'data'=>'imageItem_id',
                 'title'=>trans('admin.imageItem_id'),
		    ],
				[
                 'name'=>'imageItem_photo',
                 'data'=>'imageItem_photo',
                 'title'=>trans('admin.imageItem_photo'),
		    ],
 [
	                'name' => 'actions',
	                'data' => 'actions',
