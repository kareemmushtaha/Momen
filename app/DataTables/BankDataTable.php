...
class BankDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.bank.buttons.actions')
            ->addColumn('bank_photo', 'admin.bank.buttons.bank_photo')
            ->addColumn('Bank_item_id', 'admin.bank.buttons.Bank_item_id')
            ...
            ->rawColumns(['checkbox','actions','bank_photo']);
    }
	    ...
	    protected function getColumns()
	    {
	        ...
	        [
				...
				[
                 'name'=>'Bank_item_id',
                 'data'=>'Bank_item_id',
                 'title'=>trans('admin.Bank_item_id'),
		    ],
				[
                 'name'=>'Bank_name',
                 'data'=>'Bank_name',
                 'title'=>trans('admin.Bank_name'),
		    ],
				[
                 'name'=>'bank_photo',
                 'data'=>'bank_photo',
                 'title'=>trans('admin.bank_photo'),
		    ],
 [
	                'name' => 'actions',
	                'data' => 'actions',
