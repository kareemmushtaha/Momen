                ...
                <li> Enable Notifications
                    ...
                    <li> Allow Tracking
                        ...
                        <div class="page-footer">
                            <div class="page-footer-inner"> 2019 &copy; جميع الحقوق محفوظة <a href="#"> ايكوفن للبرمجيات</a> </div>
                        ...
                        <script src="{{url('design/admin_panel')}}/assets/pages/scripts/components-editors.min.js" type="text/javascript"></script>

                        <script src="https://cdn.ckeditor.com/4.10.0/full/ckeditor.js"></script>
                        <script src="{{url('design/admin_panel')}}/assets/global/plugins/bootstrap-summernote/summernote.min.js" type="text/javascript"></script>
