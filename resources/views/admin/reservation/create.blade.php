  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="row">
                <form action="{{ aurl('/users') }} " method="post">
                    <input type="hidden" name="_token" value="{{csrf_token()}}">
                    <input type="hidden" name="_method" value="post">
                    <input type="hidden" name="type" value="resivetion">
                    <div class="form-group">
                        <label for="name" class="col-md-3 control-label">{{trans('admin.name')}}</label>

                        <div class="col-md-12">
                            <input type="text" id=""  autocomplete="off"  name="name" value="{{old('Reservation_start_date')}}" class="form-control" placeholder="{{trans('admin.name')}}" />
                    ...
                    <br>
                    <div class="form-group">
                        <label for="national_id" class="col-md-3 control-label">{{trans('admin.NationalID')}}</label>

                        <div class="col-md-12">
                            <input type="text" id=""  autocomplete="off"  name="national_id" value="{{old('national_id')}}" class="form-control" placeholder="{{trans('admin.NationalID')}}" />
                    ...
                    <br>
                    <div class="form-group">
                        <label for="phone" class="col-md-3 control-label">{{trans('admin.phone')}}</label>

                        <div class="col-md-12">
                            <input type="text" id=""  autocomplete="off"  name="phone" value="{{old('phone')}}" class="form-control" placeholder="{{trans('admin.phone')}}" />
...
<form action="{{aurl('/reservation')}}" enctype="multipart/form-data" class="form-horizontal form-row-seperated" method="post" id="reservation">
<input type="hidden" name="_token" value="{{csrf_token()}}">
<input type="hidden" name="_method" value="post">
<input type="hidden" name="overnight" id="overnight" value="{{old('overnight')}}">
<input type="hidden" name="price" id="price" value="{{old('price')}}">
<input type="hidden" id="Reservation_end_date" name="Reservation_end_date" value="{{old('Reservation_end_date')}}" class="form-control" placeholder="{{trans('admin.Reservation_end_date')}}" />
    ...
    <div class="col-md-6">
        ...
        <div class="col-md-9">
                <select id="Reservation_item_id" name="Reservation_item_id" class="form-control" placeholder="{{trans('admin.Reservation_item_id')}}" >
                    ...
                    <option value="{{ $Reservation_item_id->id }}" {{old('Reservation_item_id') == $Reservation_item_id->id?'selected':''}}>{{ $Reservation_item_id->Item_name }}</option>
                    @endforeach
                </select>
        </div>
    </div>
...
<div class="form-group">
    <div class="col-md-6">
        ...
        <div class="col-md-9">
            <input type="text" id="Reservation_start_date"  autocomplete="off" disabled name="Reservation_start_date" value="{{old('Reservation_start_date')}}" class="form-control" placeholder="{{trans('admin.Reservation_start_date')}}" />
        </div>
    </div>
    <div class="col-md-6">
        ...
        <div class="col-md-9">
                <select id="Reservation_user_id" name="Reservation_user_id" class="form-control" placeholder="{{trans('admin.Reservation_user_id')}}" >
                    ...
                    <option value="{{ $Reservation_user_id->id }}" {{old('Reservation_user_id') == $Reservation_user_id->id?'selected':''}}>{{ $Reservation_user_id->name }}</option>
                    @endforeach
                </select>
        </div>
    </div>
...
<div class="form-group">
    <div class="col-md-6">
        ...
        <div class="col-md-9">
            <input type="text" id="Reservation_start_time" readonly name="Reservation_start_time" value="{{old('Reservation_start_time')}}" class="form-control" placeholder="{{trans('admin.Reservation_start_time')}}" />
        </div>
    </div>
    <div class="col-md-6">
        <label for="Reservation_end_time"  class="col-md-3 control-label">{{trans('admin.Reservation_end_time')}}</label>
        <div class="col-md-9">
            <input type="text" id="Reservation_end_time" readonly name="Reservation_end_time" value="{{old('Reservation_end_time')}}" class="form-control" placeholder="{{trans('admin.Reservation_end_time')}}" />
        </div>
    </div>
</div>
...
<div class="form-group">
    <div class="col-md-6">
        ...
        <div class="col-md-9">
            <input type="text" id="Reservation_price" name="Reservation_price" value="{{old('Reservation_price')}}" class="form-control" placeholder="{{trans('admin.Reservation_price')}}" />
        </div>
    </div>
    <div class="col-md-6">
		...
		<div class="col-md-9">
            <select id="Reservation_status" name="Reservation_status" class="form-control" placeholder="{{trans('admin.Reservation_status')}}" >
                <option value="pending" {{old('Reservation_status') == 'pending'?'selected':''}} >{{trans('admin.pending')}}</option>
                <option value="done" {{old('Reservation_status') == 'done'?'selected':''}} >{{trans('admin.done')}}</option>
                <option value="canceled" {{old('Reservation_status') == 'canceled'?'selected':''}} >{{trans('admin.canceled')}}</option>
            </select>
		</div>
    </div>
</div>
...
<div class="form-group" id="Reservation_overnight_hidden" >
    <div class="col-md-6">
        <div class="col-md-4">
            <input type="checkbox" id="Reservation_overnight" name="Reservation_overnight" class="form-control" style="height: 30px;width: 30px;margin-right: auto;" {{old('Reservation_overnight') == '1'?'checked':''}}>
         </div>
