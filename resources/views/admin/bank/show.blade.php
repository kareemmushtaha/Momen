              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('bank/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.bank')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$bank->id}} ؟
...
<b>{{trans('admin.id')}} :</b> {{$bank->id}}
</div>
<div class="clearfix"></div>
<hr />

<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.Bank_item_id')}} :</b>
 {!! $bank->Bank_item_id !!}
</div>
