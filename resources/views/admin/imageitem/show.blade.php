              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('imageitem/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.imageitem')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$imageitem->id}} ؟
...
<b>{{trans('admin.id')}} :</b> {{$imageitem->id}}
</div>
...
<b>{{trans('admin.admin_id')}} :</b>
 {{ App\Admin::find($imageitem->admin_id)->name }}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.items')}} :</b>
 {!! $imageitem->items !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.imageItem_id')}} :</b>
 {!! $imageitem->imageItem_id !!}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.imageItem_photo')}} :</b>
 {!! $imageitem->imageItem_photo !!}
</div>
