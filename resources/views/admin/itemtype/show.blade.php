              ...
              <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('itemtype/create')}}"
                           data-toggle="tooltip" title="{{trans('admin.itemtype')}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                                {{trans('admin.ask_del')}} {{trans('admin.id')}} {{$itemtype->id}} ؟
...
<b>{{trans('admin.id')}} :</b> {{$itemtype->id}}
</div>
...
<b>{{trans('admin.admin_id')}} :</b>
 {{ App\Admin::find($itemtype->admin_id)->name }}
</div>


<div class="col-md-4 col-lg-4 col-xs-4">
<b>{{trans('admin.ItemType_name')}} :</b>
