		...
		<div class="widget-extra body-req portlet light bordered">
			...
			<div class="portlet-body form">
				<div class="col-md-12">
					...
					<br>
					<div class="form-group">
						{!! Form::label('national_id',trans('admin.NationalID'),['class'=>'col-md-3 control-label']) !!}
						<div class="col-md-9">
							{!! Form::text('national_id', $users->national_id ,['class'=>'form-control','placeholder'=>trans('admin.NationalID')]) !!}
						</div>
					</div>
					<br>

					<div class="form-group">
						{!! Form::label('phone','رقم التلفون',['class'=>'col-md-3 control-label']) !!}
						<div class="col-md-9">
							{!! Form::text('phone',$users->phone,['class'=>'form-control','placeholder'=>'رقم التلفون']) !!}
						</div>
					</div>
					<br>
