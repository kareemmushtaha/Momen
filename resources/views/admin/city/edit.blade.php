		...
		<div class="widget-extra body-req portlet light bordered">
			...
			<div class="portlet-body form">
				<div class="col-md-12">
					...
					{!! Form::open(['url'=>aurl('/city/'.$users->id),'method'=>'put','id'=>'city','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<select class="form-control" name="area_id" id="">
								...
								<option value="{{ $area->id }}" {{ $users->area_id == $area->id ? "selected" : "" }}>{{ $area->name }}</option>
