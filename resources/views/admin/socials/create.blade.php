			...
			<div class="portlet-body form">
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							{!! Form::text('url_name',old('url_name'),['class'=>'form-control','placeholder'=>trans('admin.url_name')]) !!}
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-md-9">
							{!! Form::text('fa_icon',old('fa_icon'),['class'=>'form-control','placeholder'=>trans('admin.fa_icon')]) !!}
						</div>
					</div>
					<br>
					<div class="form-group">
						...
						<div class="col-md-9">
							{!! Form::url('url',old('url'),['class'=>'form-control','placeholder'=>trans('admin.url')]) !!}
						</div>
					</div>
					<br>
