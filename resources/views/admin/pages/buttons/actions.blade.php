<div class="actions">
	<div class="btn-group">
		...
		<ul class="dropdown-menu pull-right">
			<li>
				<a href="{{ aurl('/pages/'.$id.'/edit')}}"><i class="fa fa-pencil-square-o"></i> {{trans('admin.edit')}}</a>
			</li>
			<li class="divider"> </li>
			<li>
				<a href="{{ aurl('/pages/'.$id)}}"><i class="fa fa-eye"></i> {{trans('admin.show')}}</a>
			</li>
			@if($status == 'pending')
			<li>
				<a href="{{ aurl('/pages/'.$id.'/active?status=active')}}"><i class="fa fa-check"></i> {{trans('admin.do_active')}}</a>
			</li>
			@else
			<li>
				<a href="{{ aurl('/pages/'.$id.'/active?status=pending')}}"><i class="fa fa-check"></i> {{trans('admin.pending')}}</a>
			</li>
			@endif
			<li>
